...
model = load_model('dicebalanced256model.h5', custom_objects={'dice_coef_loss':dice_coef_loss,'f1_m':f1_m, 'recall_m':recall_m, 'precision_m':precision_m})
...
np.save("balanced_dice_predictions_256", predictions)
