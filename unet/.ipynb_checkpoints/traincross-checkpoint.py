...
train_data_file = np.load('/share/pi/hackhack/Breast/Breast_MRI/ericjason230/full_train_data_256.npz', allow_pickle=True)
train_labels_file = np.load('/share/pi/hackhack/Breast/Breast_MRI/ericjason230/full_train_label_256.npz', allow_pickle=True)
...
model.save('crossentropy256savedmodel.h5')
