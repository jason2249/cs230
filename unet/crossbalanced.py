...
model = load_model('crossbalanced256model.h5', custom_objects={'f1_m':f1_m, 'recall_m':recall_m, 'precision_m':precision_m})
...
np.save("balanced_cross_predictions_256", predictions)
