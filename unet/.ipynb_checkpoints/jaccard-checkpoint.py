...
test_data_file = np.load('/share/pi/hackhack/Breast/Breast_MRI/ericjason230/full_test_data_256.npz')
test_labels_file = np.load('/share/pi/hackhack/Breast/Breast_MRI/ericjason230/full_test_label_256.npz')
...
model = load_model('jaccard256model.h5', custom_objects={'f1_m':f1_m, 'recall_m':recall_m, 'precision_m':precision_m})
...
np.save("full_jaccard_predictions_256", predictions)
